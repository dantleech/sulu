                ...
                ->arrayNode('synchronize')
                    ...
                    ->children()
                        ...
                        ->arrayNode('default_mapping')
                            ...
                            ->children()
                                ->arrayNode('auto_sync')
                                    ->info('Automatically synchronize when document is persisted / removed / moved / deleted')
                        ...
                        ->arrayNode('mapping')
                            ...
                            ->prototype('array')
                                ->children()
                                    ->arrayNode('auto_sync')
                                        ->info('Automatically synchonize when document is persisted / removed / moved / deleted')
                                        ->prototype('scalar')->end()
                                    ->end()
                                    ->arrayNode('cascade_referrers')
                                        ->info('Cascade syncronization for the given document to any relations of the given types.')
                                        ->prototype('scalar')->end()
                                    ->end()
                                ->end()
                            ->end()
